...
while True:
    ...
    if tamagotchi_mood == 0 or tamagotchi_mood == 1:
        ...
        if pet_tamagotchi == "Y":
            ...
            print("You chose not to pet your tamagotchi. Your tamagotchi died of loneliness.")
        ...
        if feed_tamagotchi == "Y":
            ...
            print("You chose not to feed your tamagotchi. Your tamagotchi died of hunger.")
    else:
        break
